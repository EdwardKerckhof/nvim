...
M.setup = function()
  ...
  for i, kind in ipairs(kinds) do kinds[i] = lspKind.cmp_kind[kind] or kind end
  ...
  cmp.setup({
    ...
    sources = {
      {name = "nvim_lsp"}, {name = "path"}, {name = "luasnip"}, {name = "cmp_tabnine"}, {name = "nvim_lua"}, {name = "buffer"}, {name = "calc"},
